...
public static class ServiceNow
{
    ...
    /// <summary>
    /// Frends Task for updating a record in ServiceNow instance.
    /// [Documentation](https://tasks.frends.com/tasks/frends-tasks/Frends.ServiceNow.UpdateRecord).
    /// </summary>
    /// <param name="input">Input parameters.</param>
    /// <param name="options">Options parameters.</param>
    /// <param name="cancellationToken">Cancellation token given by Frends.</param>
    /// <returns>Object { dynamic Body, Dictionary&lt;string, string&gt; Headers, int StatusCode }</returns>
    public static async Task<Result> UpdateRecord([PropertyTab] Input input, [PropertyTab] Options options, CancellationToken cancellationToken)
    {
